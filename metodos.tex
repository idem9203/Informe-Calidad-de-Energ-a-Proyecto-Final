\chapter{Materiales y Métodos} \label{sec:Metodos}
...
%\begin{figure}[H]
%\centering
%\includegraphics[width=0.6\textwidth]{./image/DiagramaBloques.png}
...
%\begin{figure}[H]
%\centering
%\includegraphics[width=0.7\textwidth]{./Documentos_PDF/Diagrama_de_Bloques_sistema_Insole.pdf}
%\caption{Diagrama de Bloques del sistema de adquisición de datos.}
%\label{fig:DiagramaBloque}
%\end{figure}
